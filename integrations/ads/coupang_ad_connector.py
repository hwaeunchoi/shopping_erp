"""
integrations/ads/coupang_ad_connector.py
----------------------------------------------
쿠팡광고 더미 커넥터 (AdCampaign.ad_platform_code == "coupang_ad"와 매핑).
"""
...
class CoupangAdConnector(BaseAdConnector):
    ad_platform_code = "coupang_ad"
