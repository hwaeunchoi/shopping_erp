"""
integrations/ads/naver_search_ad_connector.py
---------------------------------------------------
네이버 검색광고 더미 커넥터 (AdCampaign.ad_platform_code == "naver_search_ad"와 매핑).
"""
...
class NaverSearchAdConnector(BaseAdConnector):
